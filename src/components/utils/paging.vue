<template>
  <div class="paging">
    ...
    <div class="pagination-bar">
      <el-button class="pre" style="border:none" icon="el-icon-arrow-left" :disabled="isStart"></el-button>
      <ul class="pager-tree">
        <li
          class="pager-value"
      ...
      <el-button class="next" style="border:none" icon="el-icon-arrow-right" :disabled="isEnd"></el-button>
    </div>
